...
<body>
<h1>Flexigrid in Codeigniter Documentation</h1>
<p>This Documentation is created by <strong>Frederico Carvalho(frederico at eyeviewdesign.com)</strong>. Just Added here for clarity of his library</p>
<div class="centerBox"><a href="<?php echo site_url("/flexigrid/");?>">About</a> | <a href="<?php echo site_url("/flexigrid/demo");?>">Grid Demo</a> | <a href="<?php echo site_url("/flexigrid/search");?>">Search Demo</a> | <a href="<?php echo site_url("/flexigrid/example");?>">Documentation</a> | <a href="http://flexigrid.eyeviewdesign.com/<?php echo $download_file;?>">Download</a></div><h1>Files Needed:</h1>
<p>
- <a href="http://flexigrid.eyeviewdesign.com/<?php echo $download_file;?>">Click here to download CI Flexigrid with samples</a><br/>
- <a href="http://codeigniter.com/download.php/">Download Codeigniter 2.1.0</a>
</p>
<h1>Introduction:</h1>
<p>
