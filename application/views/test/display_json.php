...
$(document).ready(function(){
	var table = '<table border=1><tr>';
		...
		table += '<th>#</th>';
	table +='</tr>';
    $.getJSON("<?=site_url();?>test/json",function(data){
    	$.each(data, function(key,value){
    		...
    		table += "<td><a id='"+value.id+"' class='edit' href='#'>Edit</a></td>";
    		table +='</tr>';
    	});
...
<body>
    ...
    //$(document).ready(function(){                          
        //$("button").click(function(){                                  
            //var data= [];
            //data +="<a href='#' class='test' id='1'>click me</a><br>";
            //data +="<a href='#' class='test' id='2'>click me</a>"
            //$("h2").html(data);                          
