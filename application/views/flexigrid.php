...
<div style="font-size:18px; text-align:center"><a href="<?php site_url("/flexigrid/flexigrid");?>">Demo</a> | <a href="<?php site_url("/flexigrid/example");?>">Documentation</a> | <a href="http://flexigrid.eyeviewdesign.com/<?php $download_file;?>">Download</a></div>
<h1>About:</h1>
...
- Added support for "json_encode" function from the JSON PHP Extension. <a href="<?php site_url("/flexigrid/example#s3");?>">Read more here</a><br/><br/>
- <a href="http://flexigrid.eyeviewdesign.com/<?php $download_file;?>" target="_blank">Click here to download v<?php $version;?></a>
...
- Added "build_query" function to library for active record query build. Function "build_querys" is still present but deprecated. <a href="<?php site_url("/flexigrid/example#s2");?>">Read more here</a><br/><br/>
<h1>v0.3 Change log:</h1>
- Fixed some helper bugs<br/><br/>
- Removed "width" and "height" parameter and replaced it with an array where you can insert any FlexiGrid parameter you want. Read more about these changes <a href="<?php site_url("/flexigrid/example#s1");?>">here</a>.<br/><br/>
- The $buttons variable in the "build_grid_js" function is now the last parameter and optional<br/><br/>
<h1>Demo (v<?php $version;?>):</h1>
...
- <a href="<?php site_url("/flexigrid/example");?>">Read documentation here</a>
